...
hierarchy = {
    ...
    KIND_ROUTE:           [KIND_POSTAL_CODE_PREFIX],
    ...
    KIND_SUBLOCALITY_L2:  [KIND_SUBLOCALITY_L1],
    KIND_SUBLOCALITY_L3:  [KIND_SUBLOCALITY_L2],
    KIND_SUBLOCALITY_L4:  [KIND_SUBLOCALITY_L3],
    KIND_NEIGHBORHOOD:    [KIND_SUBLOCALITY_L4],
    KIND_PREMISE:         [KIND_FLOOR],
    KIND_SUBPREMISE:      [KIND_PREMISE],
    KIND_POSTAL_CODE_PREFIX: [KIND_POSTAL_CODE],
    KIND_POSTAL_CODE:     [KIND_POSTAL_CODE_SUFFIX],
    KIND_POSTAL_CODE_SUFFIX: [KIND_POSTAL_TOWN],
    ...
    KIND_FLOOR:           [KIND_STREET_NUMBER],
    KIND_ESTABLISHMENT:   [KIND_FLOOR],
    KIND_PARKING:         [KIND_STREET_NUMBER],
